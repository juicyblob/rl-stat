...
<template>
    <div class="mt-4">
        <div class="text-xs/[1] text-(--color-muted) flex mb-2">
            <span class="pl-3">Num</span>
            <span class="pl-21">Date</span>
            <span class="pl-19">Score</span>
            <span class="pl-15">Result</span>
            <span class="pl-15.5">Goals</span>
            <span class="pl-5">Assists</span>
            <span class="pl-5">Saves</span>
            <span class="pl-12">Mode</span>
        ...
        <div class="flex flex-col gap-2" v-else>
            <MatchRow
                ...
                :saves="match.saves"
                :mode="match.mode"
                :match_comment="match.match_comment ?? ''" />
        </div>
